...
@media(max-width:600px){.tab-nav{position:relative;width:100%;flex-direction:row;padding:10px;flex-wrap:wrap;}.tab-nav>*{flex:1;min-width:60px;}.wrap{margin:0;padding:12px;}}
...
{acc_html}
<div class='tab-nav'>
<button class='tab active' onclick="this.classList.add('active')">📊 48隊 + 實力</a>
<button class='tab' onclick="this.classList.add('active')">📅 104場賽程</a>
<button class='tab' onclick="this.classList.add('active')">📈 實力分佈</a>
<button class='tab' onclick="this.classList.add('active')">🏆 淘汰賽</a>
<button class='tab' onclick="this.classList.add('active')">🏅 捧盃概率</a>
</div>
