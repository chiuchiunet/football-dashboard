...
for g in 'ABCDEFGHIJKL':
    rows=''; 
    for t in GD[g]: rows+=f'<tr><td>{fl(t)[0]} {t}</td><td>{rt(t)}</td><td>{cn(t)}</td></tr>'
...
<div class="legend">
<h3>預測解釋</h3>
<div class="li"><span class="dot" style="background:#4CAF50;"></span><span><b>實力值</b> = 基於 FIFA 排名同近期表現</span></div>
...
<div class="ft">Updated: ''' + today_str + '''</div>
</div>
</body>
</html>'''
