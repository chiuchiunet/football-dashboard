...
{acc_html}
<div class='tab-nav'>
<button class='tab active' onclick="var t=document.querySelectorAll('.tab');for(var i=0;i<t.length;i++)t[i].classList.remove('active');this.classList.add('active')">📊 48隊 + 實力</a>
<button class='tab' onclick="var t=document.querySelectorAll('.tab');for(var i=0;i<t.length;i++)t[i].classList.remove('active');this.classList.add('active')">📅 104場賽程</a>
<button class='tab' onclick="var t=document.querySelectorAll('.tab');for(var i=0;i<t.length;i++)t[i].classList.remove('active');this.classList.add('active')">📈 實力分佈</a>
<button class='tab' onclick="var t=document.querySelectorAll('.tab');for(var i=0;i<t.length;i++)t[i].classList.remove('active');this.classList.add('active')">🏆 淘汰賽</a>
<button class='tab' onclick="var t=document.querySelectorAll('.tab');for(var i=0;i<t.length;i++)t[i].classList.remove('active');this.classList.add('active')">🏅 捧盃概率</a>
</div>
