...
for idx, m in enumerate(ALL_MATCHES):
    ...
    if day!=cur:
        if day_matches:
            ...
            day_matches=[]
        mm.append(f"<div class='md collapsed' data-stage='{st}'><span class='md-toggle'>▶</span>{icon} {day} <span style='font-size:0.65rem;color:#888;margin-left:6px;'>({lbl})</span></div>")
        cur=day
...
<button class="sf-btn" onclick="expandAll()" style="margin-left:auto;">📂 展開</button>
<button class="sf-btn" onclick="collapseAll()">📁 收合</button>
</div>
