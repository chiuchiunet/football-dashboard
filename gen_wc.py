...
@media(max-width:600px){.bnav{display:flex;}.wrap{padding-bottom:70px;}.hero{padding:16px;border-radius:12px;}.hero h1{font-size:1.4rem;}.stats{gap:4px;}.sc{padding:6px;}.scn{font-size:0.9rem;}.tab{padding:8px 12px;font-size:0.65rem;}.gg{grid-template-columns:1fr;gap:8px;}.gc{font-size:0.9rem;}.gt{font-size:0.55rem;}.mhd{flex-wrap:wrap;gap:4px;padding:6px 8px;}.mcomp{font-size:0.55rem;}.mhkt,.mvenue,.mchan{font-size:0.5rem;}.mbody{padding:8px;gap:6px;}.mteam{flex:1 1 auto;font-size:0.75rem;min-width:60px;}.mscore{font-size:1.1rem;padding:0 8px;}.mxg{font-size:0.5rem;}.mc{padding:8px;}}"""
