...
{acc_html}
<div class='tab-nav'>
<button class='tab active' onclick="document.getElementById('groups').style.display='block';document.getElementById('schedule').style.display='none';document.getElementById('strength').style.display='none';document.getElementById('bracket').style.display='none';document.getElementById('trophy').style.display='none';this.classList.add('active');document.querySelectorAll('.tab')[0].classList.remove('active');document.querySelectorAll('.tab')[1].classList.remove('active');document.querySelectorAll('.tab')[2].classList.remove('active');document.querySelectorAll('.tab')[3].classList.remove('active');document.querySelectorAll('.tab')[4].classList.remove('active')">📊 48隊 + 實力</a>
<button class='tab' onclick="document.getElementById('schedule').style.display='block';document.getElementById('groups').style.display='none';document.getElementById('strength').style.display='none';document.getElementById('bracket').style.display='none';document.getElementById('trophy').style.display='none';this.classList.add('active');document.querySelectorAll('.tab')[1].classList.remove('active');document.querySelectorAll('.tab')[0].classList.remove('active');document.querySelectorAll('.tab')[2].classList.remove('active');document.querySelectorAll('.tab')[3].classList.remove('active');document.querySelectorAll('.tab')[4].classList.remove('active')">📅 104場賽程</a>
<button class='tab' onclick="document.getElementById('strength').style.display='block';document.getElementById('groups').style.display='none';document.getElementById('schedule').style.display='none';document.getElementById('bracket').style.display='none';document.getElementById('trophy').style.display='none';this.classList.add('active');document.querySelectorAll('.tab')[2].classList.remove('active');document.querySelectorAll('.tab')[0].classList.remove('active');document.querySelectorAll('.tab')[1].classList.remove('active');document.querySelectorAll('.tab')[3].classList.remove('active');document.querySelectorAll('.tab')[4].classList.remove('active')">📈 實力分佈</a>
<button class='tab' onclick="document.getElementById('bracket').style.display='block';document.getElementById('groups').style.display='none';document.getElementById('schedule').style.display='none';document.getElementById('strength').style.display='none';document.getElementById('trophy').style.display='none';this.classList.add('active');document.querySelectorAll('.tab')[3].classList.remove('active');document.querySelectorAll('.tab')[0].classList.remove('active');document.querySelectorAll('.tab')[1].classList.remove('active');document.querySelectorAll('.tab')[2].classList.remove('active');document.querySelectorAll('.tab')[4].classList.remove('active')">🏆 淘汰賽</a>
<button class='tab' onclick="document.getElementById('trophy').style.display='block';document.getElementById('groups').style.display='none';document.getElementById('schedule').style.display='none';document.getElementById('strength').style.display='none';document.getElementById('bracket').style.display='none';this.classList.add('active');document.querySelectorAll('.tab')[4].classList.remove('active');document.querySelectorAll('.tab')[0].classList.remove('active');document.querySelectorAll('.tab')[1].classList.remove('active');document.querySelectorAll('.tab')[2].classList.remove('active');document.querySelectorAll('.tab')[3].classList.remove('active')">🏅 捧盃概率</a>
</div>
...
<button class="sf-btn active" onclick="filterStage('all',this)">全部</a>
<button class="sf-btn" onclick="filterStage('GS',this)">📅 分組</a>
<button class="sf-btn" onclick="filterStage('R32',this)">🎯 32強</a>
<button class="sf-btn" onclick="filterStage('R16',this)">⚡ 16強</a>
<button class="sf-btn" onclick="filterStage('QF',this)">🔥 8強</a>
<button class="sf-btn" onclick="filterStage('SF',this)">🏆 決賽</a>
<button class="sf-btn fav-filter" onclick="toggleFavFilter(this)" style="margin-left:auto;">⭐ 我的最愛</a>
</div>
